...
map.getView().fit([8719678.534165, 1268821.222240, 8777759.447542, 1302535.315012], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Thammampatty Range Map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (78 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This Map Shows Jurisdiction and Important details of Thammampatty Forest range';
            }
