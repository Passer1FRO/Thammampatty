...
var format_AssetsList_6 = new ol.format.GeoJSON();
var features_AssetsList_6 = format_AssetsList_6.readFeatures(json_AssetsList_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_AssetsList_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_AssetsList_6.addFeatures(features_AssetsList_6);
var lyr_AssetsList_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_AssetsList_6, 
                style: style_AssetsList_6,
                popuplayertitle: 'Assets List',
                interactive: true,
                title: '<img src="styles/legend/AssetsList_6.png" /> Assets List'
            });

lyr_ESRISatellite_0.setVisible(true);lyr_Thammampattyrange_1.setVisible(false);lyr_ManmalaiSection_2.setVisible(false);lyr_ThammampattySection_3.setVisible(true);lyr_OffenceData_4.setVisible(true);lyr_Places_5.setVisible(true);lyr_AssetsList_6.setVisible(true);
var layersList = [lyr_ESRISatellite_0,lyr_Thammampattyrange_1,lyr_ManmalaiSection_2,lyr_ThammampattySection_3,lyr_OffenceData_4,lyr_Places_5,lyr_AssetsList_6];
...
lyr_AssetsList_6.set('fieldAliases', {'#': '#', 'Section': 'Section Name', 'Beat': 'Beat Name', 'Located In': 'Location', 'Location/RF/RL Name': 'RF/RL', 'Lat': 'Lat', 'Long': 'Long', 'Asset Name': 'Asset name', 'Condition': 'Condition', 'Category': 'Catagory', });
...
lyr_AssetsList_6.set('fieldImages', {'#': 'Hidden', 'Section': 'TextEdit', 'Beat': 'TextEdit', 'Located In': 'TextEdit', 'Location/RF/RL Name': 'TextEdit', 'Lat': 'Hidden', 'Long': 'Hidden', 'Asset Name': 'TextEdit', 'Condition': 'TextEdit', 'Category': 'TextEdit', });
...
lyr_AssetsList_6.set('fieldLabels', {'Section': 'inline label - always visible', 'Beat': 'inline label - always visible', 'Located In': 'inline label - always visible', 'Location/RF/RL Name': 'inline label - always visible', 'Asset Name': 'inline label - always visible', 'Condition': 'inline label - always visible', 'Category': 'inline label - always visible', });
lyr_AssetsList_6.on('precompose', function(evt) {
